...
- **Learnings graph-schema conversion (2026-03-01)**: 74 graph-compliant entries (L-0001–L-0141) across type-specific files. Some old-format entries may remain in `.specs/learnings/` files. Two agent prompts ready (Prompts 4 & 5) for converting those. Studio candidate.
